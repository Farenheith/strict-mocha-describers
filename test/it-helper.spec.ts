...
describe('ItHelper', () => {
  ...
  describe('.createSuiteCase()', () => {
    ...
    beforeEach(() => {
      testFunction = sinon
        .stub()
        .callsFake((_description, callback) => callback());
    ...
    it('should create testCase function that calls original testFunction and callback chained', () => {
      ...
      expect(testFunction).to.have.been.calledOnceWithExactly(
        'test description',
        sinon.match.func,
      );
  ...
  describe('.backupInstance()', () => {
    beforeEach(() => {
      sinon
        .stub(testUtils, 'prepare')
        .callsFake(
          (x) => (x === instance ? 'instance backup' : 'class backup') as any,
        );
    });
    ...
    it('should prepare target to be tested and keep backup of methods', () => {
      ...
      expect(testUtils.prepare)
        .to.have.been.calledTwice.calledWithExactly(
          instance,
          Test.prototype,
          'method1',
        )
  ...
  describe('.beforeEach', () => {
    ...
    it('should call bootstrap and backupInstance', () => {
      ...
      expect(target['backupInstance']).to.have.been.calledOnceWithExactly(
        'method1',
      );
    });
  });
  ...
  describe('.afterEach', () => {
    ...
    it('should restore backup of instance and class', () => {
      ...
      expect(backupHelper.restore)
        .to.have.been.calledTwice.calledWithExactly(instance, 'instance backup')
