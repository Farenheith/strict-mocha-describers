...
describe('MethodDescribeHelper', () => {
  ...
  describe('.createMethodDescribe()', () => {
    ...
    beforeEach(() => {
      ...
      fn = sinon
        .stub()
        .callsFake((_it, getTarget) => (targetInstance = getTarget()));
      ...
      createStaticDescribe = sinon
        .stub(target, 'createStaticDescribe')
        .returns('createStaticDescribe result' as any);
      sinon.stub(ItHelper, 'ItHelper').returns({
        createIt,
        beforeEach: itHelperBeforeEach,
        afterEach: itHelperAfterEach,
        target: instance,
      });
    });
    ...
    it('should return a method describer', () => {
      ...
      expect(global.beforeEach).to.have.been.calledOnce.calledOnceWithExactly(
        'beforeEachCallback',
      );
