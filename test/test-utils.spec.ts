...
describe('testUtils', () => {
  ...
  describe('mountInstanceTest', () => {
    ...
    it('should mount a test describer correctly', () => {
      ...
      expect(testUtils.prepare)
        .calledTwice.calledWithExactly(test, Test.prototype, 'method1')
  ...
  describe('mountStaticTest', () => {
    ...
    it('should mount a test describer correctly', () => {
      const result = testUtils.mountStaticTest(Test, 'staticMethod1', callback);

      expect(global.beforeEach).calledOnceWithExactly(sinon.match.func);
      expect(testUtils.prepare).calledOnceWithExactly(
        Test,
        Test,
        'staticMethod1',
      );
